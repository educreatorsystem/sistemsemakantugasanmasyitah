const SHEET_ID = '1s6XIB_ri4HDW1tjFh5-Pp4NykXno8RG4sZ6SJySmcq4';
const RECORD_SHEET_NAME = 'Rekod Penghantaran';
const STUDENT_SHEET_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTyjYwrg6cADA-JgKZxtFJLI_beU1ooXYBRXa5KLhosk_QBbusTLjPDa5eH_C1gpWQ8aa4R5XQzbk8K/pub?gid=0&single=true&output=csv';
const SUBJECT_SHEET_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTyjYwrg6cADA-JgKZxtFJLI_beU1ooXYBRXa5KLhosk_QBbusTLjPDa5eH_C1gpWQ8aa4R5XQzbk8K/pub?gid=2122786713&single=true&output=csv';
const HEADERS = [
  'id',
  'className',
  'date',
