...
```js
const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzDADvrj66ZCHFBGf2a-0m_YYLLXCebFRZ8jDTd1fAellZESs75yVWkh2uD7f4WS1WlxQ/exec";
```
...
```text
1s6XIB_ri4HDW1tjFh5-Pp4NykXno8RG4sZ6SJySmcq4
```

URL Apps Script semasa:

```text
https://script.google.com/macros/s/AKfycbzDADvrj66ZCHFBGf2a-0m_YYLLXCebFRZ8jDTd1fAellZESs75yVWkh2uD7f4WS1WlxQ/exec
```

CSV Kelas dan Nama Murid semasa:

```text
https://docs.google.com/spreadsheets/d/e/2PACX-1vTyjYwrg6cADA-JgKZxtFJLI_beU1ooXYBRXa5KLhosk_QBbusTLjPDa5eH_C1gpWQ8aa4R5XQzbk8K/pub?gid=0&single=true&output=csv
```

CSV Subjek semasa:

```text
https://docs.google.com/spreadsheets/d/e/2PACX-1vTyjYwrg6cADA-JgKZxtFJLI_beU1ooXYBRXa5KLhosk_QBbusTLjPDa5eH_C1gpWQ8aa4R5XQzbk8K/pub?gid=2122786713&single=true&output=csv
```
